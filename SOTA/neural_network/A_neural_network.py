...
class A_neural_network():
    ...
    @classmethod
    def get_data2(cls, crf_training_data_filename, crf_testing_data_filename):
        """
        ...
        crf_training_dataset,_ = Dataset.get_crf_training_data(crf_training_data_filename)
        document_sentence_words = None
        document_sentence_tags = None
        ...
        return index2word, word2index, index2label, label2index, test_document_sentence_words, test_document_sentence_tags, \
    train_document_sentence_words, train_document_sentence_tags, unique_words, n_out, n_unique_words
