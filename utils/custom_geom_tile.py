...
class custom_geom_tile(geom):
    """
    lqrz: overwrite the class. Sets the rotation of the xticklabels.
    """
    DEFAULT_AES = {}
    ...
    def _plot_unit(self, pinfo, ax):
        ...
        if 'fill' in self.aes_unique_to_geom:
            ...
            if False in [isinstance(v, (int, long, float, complex)) for v in set(fill)]:
                ...
                raise Exception(
                    'For categorical fill values specify fill in the ggplot aes instead of the geom_tile aes.')
        ...
        #lqrz: set rotation of the xticks_labels
