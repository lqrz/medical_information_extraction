...
do
	...
	stdbuf -oL sudo python SOTA/neural_network/train_neural_network.py --net tf_cnn --window 7 --epochs 20 --plot --lrtrain 0.01 --lrtune 0.01 --minibatch 256 --configini cnn_w2v_c_m.cfg --earlystop 2 --logger earlystop_region_sizes_"$i".log
	stdbuf -oL sudo python SOTA/neural_network/train_neural_network.py --net tf_cnn --window 7 --epochs 20 --plot --lrtrain 0.01 --lrtune 0.01 --minibatch 256 --configini cnn_w2v_c_m.cfg --picklelists --logger region_sizes_"$i".log
done